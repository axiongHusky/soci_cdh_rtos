...
static char set_power_response[] = {0x01, 0xF1, 0x00, 0x0E}; //Fixed checksum from 0x0F to 0x0E
static char get_power_response[] = {0x01, 0xF2, 0x01, 0x0C}; //Fixed checksum from 0x0D to 0x0C
static char set_tx_freq_response[] = {0x01, 0xB7, 0x00}; //TBD double check if we need to add another packet
static char set_rx_freq_response[] = {0x01, 0xB9, 0x00}; //TBD double check if we need to add another packet
static char set_channel_response[] = {0x01, 0x83, 0x00, 0x7C}; 
static char set_bandwidth_response[] = {0x01, 0xF0, 0x00, 0x10}; //got checksum as 0x0F?
static char set_modulation_response[] = {0x01, 0xAB}; //TBD
static char program_response[] = {0x01,0x9E, 0x00, 0x61}; // fixed checksum from 0x62 to 0x61
